...
export default function EditDiscountScreen() {
    ...
    return (
        <>
            <Stack.Screen options={{ title: 'Editar descuento', presentation: 'card', headerTitleAlign: 'center', headerRight: () => <Trailing><TrailingButton onPress={handleDelete} label='Eliminar' /><TrailingButton onPress={handleSubmit} label='Actualizar' /></Trailing> }} />
            <Body>
